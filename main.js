...
function nome(){
    nomeX = window.prompt("Nome do jogador X:")
    nomeO = window.prompt("Nome do jogador O:")
...
function marca_a1() {
    if(aux % 2 == 0){
        area1 = "X"
        a1.innerHTML = "X"
        turno.innerHTML = "<h2>É a vez do O!</h2>"
    }else{
        area1 = "O"
        a1.innerHTML = "O"
        turno.innerHTML = "<h2>É a vez do X!</h2>"
    }
...
function jogo(){
    if(area1 == area2 && area2 == area3 && area1 != null){ //linha 1
        turno.innerHTML = `<h2>Vitória do ${area1}!</h2>`
        vencedor = area1
        pontuacao()

    }else if(area4 == area5 && area5 == area6 && area4 != null){ //linha 2
        turno.innerHTML = `<h2>Vitória do ${area4}!</h2>`
        vencedor = area4
        pontuacao()

    }else if(area7 == area8 && area8 == area9 && area7 != null){ //linha 3
        turno.innerHTML = `<h2>Vitória do ${area7}!</h2>`
        vencedor = area7
        pontuacao()
        ...
        turno.innerHTML = `<h2>Vitória do ${area2}!</h2>`
        vencedor = area2
        pontuacao()

    }else if(area3 == area6 && area6 == area9 && area3 != null){ //vertical 3
        turno.innerHTML = `<h2>Vitória do ${area3}!</h2>`
        vencedor = area3
        pontuacao()
